        ...
        try {
            ...
            scoreData = scoreData.map((item) => {
                return {
                    ...
                    scoreBT: (
                        <>
                            {item.score.excerciseScore !== null &&
                                item.score.excerciseScore.toLocaleString(undefined, {
                                    minimumFractionDigits: 1
                                })}
                        </>
                    ),
                    scoreGK: (
                        <>
                            {item.score.midTermScore !== null &&
                                item.score.midTermScore.toLocaleString(undefined, {
                                    minimumFractionDigits: 1
                                })}
                        </>
                    ),
                    scoreCK: (
                        <>
                            {item.score.finalTermScore !== null &&
                                item.score.finalTermScore.toLocaleString(undefined, {
                                    minimumFractionDigits: 1
                                })}
                        </>
                    ),
                    ...
                    button: (
                        <AntSwitch
                            onChange={(e) => handleToggleEdit(e, item.score.user.userId)}
    ...
    const handleToggleEdit = async (e, studentId) => {
        ...
        if (e === true) {
            ...
            let newScoreItem = {
                ...
                button: (
                    <AntSwitch
                        onChange={(e) => handleToggleEdit(e, syncScore[index].studentId)}
                        checked={true}
                    />
                )
            }
